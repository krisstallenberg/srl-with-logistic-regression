...
def main():
    ...
    # Define file paths.
    dev_file_path = 'en_ewt-up-dev.conllu'
    # dev_file_path = 'data/en_ewt-up-dev.conllu'
    train_file_path = 'data/en_ewt-up-train.conllu'
    train_file_path = 'en_ewt-up-train.conllu'
    test_file_path = 'en_ewt-up-test.conllu'#C:\Users\pc\Desktop\NLP A2\data\en_ewt-up-test.conllu
    # test_file_path = 'data/en_ewt-up-test.conllu'#C:\Users\pc\Desktop\NLP A2\data\en_ewt-up-test.conllu
